...
[📁 Структура проекта](#структура-проекта) | [🎯 О проекте](#о-проекте) | [🔄 Пайплайн обработки данных](#пайплайн-обработки-данных) | [🧱 Архитектура модели](#архитектура-модели) | [📊 Результаты](#результаты) | [🚀 Запуск](#инструкция-по-запуску) | [⚡ Оптимизации](#оптимизации)
