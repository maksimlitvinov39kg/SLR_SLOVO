...
2) Представленные графики и метрики получены в ходе обучения на **500** классах. Замеры качества и результат работы на всём датасете(1000 классов) представлены в [папке](noteboks/1000_classes) 
